...
export const listFilesTool = {
    ...
    func: async (args) => {
        ...
        try {
            ...
            const entriesWithDirectoryMarkers = await Promise.all(dir.map(async (entry) => {
            ...
            throw new Error(`Error reading dir : ${error instanceof Error ? error.message : String(error)}`);
        }
    },
};
